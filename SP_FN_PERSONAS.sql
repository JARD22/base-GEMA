...
RETURNS TABLE (OUT_NOMBRE TEXT,OUT_TIPO_PERSONA VARCHAR,OUT_COD_TIPO_PERSONA INT,OUT_UID VARCHAR)
AS
$$
BEGIN
RETURN QUERY
...
--PERSONA POR UID
SELECT * FROM FN_PERSONA_UID('06b2b383-e41e-4765-a016-545a35fe4d79')
CREATE OR REPLACE FUNCTION FN_PERSONA_UID(IN_UID VARCHAR) RETURNS TABLE(
OUT_COD_TIPO_PERSONA INT,OUT_PRIMER_NOMBRE VARCHAR, OUT_SEGUNDO_NOMBRE VARCHAR,OUT_PRIMER_APELLIDO VARCHAR,
OUT_SEGUNDO_APELLIDO VARCHAR, OUT_DNI VARCHAR,OUT_FEC_NACIMIENTO DATE, OUT_NACIONALIDAD VARCHAR,
OUT_SEXO CHAR,OUT_DIRECCION VARCHAR,OUT_ENCARGADO BOOLEAN,OUT_OCUPACION VARCHAR,OUT_LUGAR_TRABAJO VARCHAR,
OUT_ESCOLARIDAD VARCHAR,OUT_TELEFONOS JSON
)
AS
$$
BEGIN
...
--ACTUALIZAR PERSONA FAMILIAR
CREATE OR REPLACE PROCEDURE SP_ACTUALIZAR_FAMILIAR(
					IN_DNI VARCHAR,IN_PRIMER_NOMBRE VARCHAR,IN_PRIMER_APELLIDO VARCHAR,
					IN_NACIONALIDAD VARCHAR,IN_SEXO CHAR,IN_FEC_NACIMIENTO DATE,
					IN_USR_REGISTRO VARCHAR,IN_DIRECCION VARCHAR,IN_TELEFONOS JSON,IN_LUGAR_TRABAJO VARCHAR,
	 				IN_OCUPACION VARCHAR, IN_ENCARGADO BOOLEAN,IN_ESCOLARIDAD VARCHAR,IN_UID VARCHAR,
	 				IN_SEGUNDO_NOMBRE VARCHAR DEFAULT '',IN_SEGUNDO_APELLIDO VARCHAR DEFAULT '' )
...
CALL SP_ELIMINAR_TELEFONO(1)
CREATE OR REPLACE PROCEDURE SP_ELIMINAR_TELEFONO(IN_ID INT)
AS
$$
BEGIN
...
SELECT * FROM FN_BUCAR_PERSONA('%0801%')
CREATE OR REPLACE FUNCTION FN_BUCAR_PERSONA(TERMINO VARCHAR)
RETURNS TABLE (OUT_NOMBRE TEXT,OUT_TIPO_PERSONA VARCHAR,OUT_COD_TIPO_PERSONA INT,OUT_UID VARCHAR)
AS
$$
BEGIN
...
--DATOS ALUMNO POR UID
SELECT * FROM FN_ALUMNO_UID('65e48d1b-a491-4346-8c6e-16dca801b6cd')
CREATE OR REPLACE FUNCTION FN_ALUMNO_UID(IN_UID VARCHAR)RETURNS TABLE(
OUT_COD_TIPO_PERSONA INT,OUT_PRIMER_NOMBRE VARCHAR,OUT_PRIMER_APELLIDO VARCHAR,OUT_SEGUNDO_NOMBRE VARCHAR, OUT_SEGUNDO_APELLIDO VARCHAR,
OUT_DNI VARCHAR,OUT_NACIONALIDAD VARCHAR, OUT_FEC_NACIMIENTO DATE,OUT_SEXO CHAR,OUT_VIVE_CON CHAR,
OUT_ENFERMEDAD VARCHAR, OUT_ESTADO BOOLEAN, OUT_MOTIVO_RETIRO VARCHAR, OUT_DIRECCION VARCHAR)
...
--ACTUALIZAR ALUMNO
CREATE OR REPLACE PROCEDURE SP_ACTUALIZAR_ALUMNO(IN_DNI VARCHAR,IN_PRIMER_NOMBRE VARCHAR,IN_PRIMER_APELLIDO VARCHAR,
					IN_NACIONALIDAD VARCHAR,IN_SEXO CHAR,IN_FEC_NACIMIENTO DATE,IN_ENFERMEDAD VARCHAR, IN_VIVE_CON VARCHAR,
					IN_DIRECCION VARCHAR,IN_UID VARCHAR,IN_ESTADO BOOLEAN,IN_MOTIVO_RETIRO VARCHAR DEFAULT '',
					IN_SEGUNDO_NOMBRE VARCHAR DEFAULT '',IN_SEGUNDO_APELLIDO VARCHAR DEFAULT '' )
AS
$$
DECLARE
...
UPDATE ALUMNOS SET MOTIVO_RETIRO ='' WHERE COD_PERSONA=24
