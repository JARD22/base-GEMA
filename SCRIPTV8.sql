...
COD_TIPO_PERSONA INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
FEC_REGISTRO DATE NOT NULL,
	...
	CONSTRAINT FK_COD_TIPO_PERSONA_TIPO_PERSONA 
	FOREIGN KEY (COD_TIPO_PERSONA)
...
COD_GRUPO INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
VIVE_CON CHAR(1),
	...
	CONSTRAINT FK_GRUPO_GRUPO_FAMILIAR FOREIGN KEY(COD_GRUPO)
	REFERENCES GRUPO_FAMILIAR(COD_GRUPO)
);
...
COD_TIPO_MATRICULA INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
NOMBRE VARCHAR(75),
...
COD_TIPO_MATRICULA INT NOT NULL,	
...
COD_CURSO_RETRASADA INT,
CLASE_RETRASADA VARCHAR(50),
CONDICIONADO BOOLEAN DEFAULT FALSE,
CONDICIONADO_MOTIVO VARCHAR(200),
USR_REGISTRO VARCHAR(50) NOT NULL,
FEC_REGISTRO DATE NOT NULL,
	
	CONSTRAINT FK_MATRICULA_TIPO_MATRICULA FOREIGN KEY(COD_TIPO_MATRICULA)
	REFERENCES TIPO_MATRICULA(COD_TIPO_MATRICULA),
	...
	CONSTRAINT FK_MATRICULA_CURSO_RETRASADA FOREIGN KEY(COD_CURSO_RETRASADA)
	REFERENCES CURSOS(COD_CURSO),
...
FEC_REGISTRO DATE,
	...
	CONSTRAINT FK_CONTRATOS_CLAUSULAS
